...
parser.add_argument('--dir',type=str, default='/home/syh/train_data/GOT10k/', help='your vid data dir')
...
save_path = os.path.join(save_dir, 'got10k.json')

if not os.path.exists(save_dir):
    os.makedirs(save_dir)

json.dump(got10k, open(save_path, 'w'), indent=4, sort_keys=True)
